try {
    $env:SUBSCRIPTION_ID = "4e090658-58de-4b9f-98f6-f87362cc941a";
    $env:RESOURCE_GROUP = "CIS_Framework";
    $env:TENANT_ID = "a4acae14-443b-454c-a066-0ca503cde468";
    $env:LOCATION = "eastus";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "ed81189a-1b14-44f3-8a63-26516d93d5b6";
